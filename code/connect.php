...
<html>
	...
	<body>
		...
		<nav class="centro">
			<button type="button" id="botao3" class="botao bt3" onclick="result()">Ver resultados</button>
			<button type="button" id="botao4" class="botao bt4" onclick="answer()">Ver gabarito</button>
		</nav>
